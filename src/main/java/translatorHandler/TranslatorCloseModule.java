 ...
 * @author Husm
 */
public class TranslatorCloseModule extends BotModule {
    /**
     * Viene richiamato al comando /meteo e in caso di comando inesistente
     * */
    TranslatorModule superModule;
    public TranslatorCloseModule(TranslatorModule m) {
        super("/close");
        superModule = m;
    }
    ...
    public BotApiMethod<Message> handleCommand(Update update) {
        ...
        m.setText("Il bot non risponde più ai comandi di /translate");
