...
public class CocktailIngredientsModule extends BotModule {
    /**
     * Viene richiamato al comando /meteo e in caso di comando inesistente
     * */
    CocktailModule superModule;
    public CocktailIngredientsModule(CocktailModule m) {
        super("/ingredienti");
        superModule = m;
    }
    ...
    public BotApiMethod<Message> handleCommand(Update update) {
        ...
        try {
            m.setText(Cocktail.getCocktailIngredientsList());
